...
void main(){
  ...
  float motion=1.0;//moving the line left or right
  float phase=sin(u_time)*10.0;//distance between the peaks. Or how often it repeats. Bigger = closer together.
  ...
  // Plot a line
  float pct=plot(line);
  color=(1.-pct)*color+pct*vec3(0.298, 0.4471, 0.7216);
