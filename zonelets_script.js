...
let headerHTML = `
<div class="header">
  <h1><a class="homeLink" href="/index.html">Learning Computer Graphics</a></h1>
  <p>oh god there is so much to learn</p>
</div>
<div class="topnav">
  <a href="/CGWebsite/index.html">Home</a>
  <a href="/CGWebsite/ShadersStudy.html">Shaders Study</a>
  <a href="/CGWebsite/Resources.html">Resources</a>
  <a href="http://editor.thebookofshaders.com/">Shader Editor</a>
  <a href="/CGWebsite/CV.html" style="float:right">CV</a>
</div>
`

//Write the Footer HTML, which has information about the blog.
let footerHTML = "<h5> This is an organic website, home - grown by yours truly using the artisanal technique of handwriting your own HTML and CSS.</h5>";
